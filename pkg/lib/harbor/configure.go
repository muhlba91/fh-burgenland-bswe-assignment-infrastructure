...
// gitlabRepositories: A map of GitLab projects that may be needed for project creation.
// githubTeams: A map of GitHub teams that may be needed for group creation.
func Configure(
	ctx *pulumi.Context,
	...
	harborRobotAccounts, hrErr := robot.Create(
		ctx,
		stackConfig.Repositories,
		githubRepositories,
		gitlabRepositories,
